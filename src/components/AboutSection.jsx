...
export const AboutSection = () => {
    return(
    <section id="about" className="py-16 px-4 sm:px-6 md:px-12 lg:px-24 relative">
        {""}
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 items-center">
                ...
                <div className="flex flex-col items-center md:items-start gap-6" >
                    <img
                        src={Photo}
                        alt="Photo de profil"
                        className="w-40 sm:w-56 md:w-[350px] h-auto aspect-square object-cover rounded-full shadow-[0_0_15px_rgba(34,197,94,0.4)] hover:border-primary/60 hover:shadow-[0_0_30px_rgba(34,197,94,0.6)] transition-all duration-500"
                    />
                            <a 
                                href={Cv} 
                                target="_blank" 
